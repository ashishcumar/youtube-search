        ...
        <div className={VideoDetailCss.typoGraphyContainer}>
          ...
          <div>
            <b className={VideoDetailCss.viewsDate}>
              ...
              <p>
                <ThumbUpOffAltIcon className={VideoDetailCss.icons} />
                <span>{parseInt(Math.random() * 100)}k </span>
                <ThumbDownOffAltIcon className={VideoDetailCss.icons} />
                <span>DISLIKE</span>
                <SendOutlinedIcon className={VideoDetailCss.icons} />
                <span>SHARE </span>
                <ContentCutOutlinedIcon className={VideoDetailCss.icons} />
                <span>CLIP </span>
                <PlaylistAddOutlinedIcon className={VideoDetailCss.icons} />
                <span>SAVE</span>
                <MoreHorizOutlinedIcon className={VideoDetailCss.icons} />
              </p>
            </b>
